...
public class BPNet {
     ...
     * @param momentum
     */
    public BPNet(int inputSize, int hiddenSize, int outputSize, double eta,
                 double momentum) {
     ...
     * @param outputSize
     */
    public BPNet(int inputSize, int hiddenSize, int outputSize) {
        this(inputSize, hiddenSize, outputSize, 0.15, 0.85);
    }
