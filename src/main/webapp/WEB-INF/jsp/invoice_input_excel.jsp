                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        <form action="addInvoiceByExcel" method="post"
                                              enctype="multipart/form-data" class="form-horizontal">
                                            <div class="form-group">
                                                <div id="preview" class="col-md-8 col-sm-8 col-xs-8">
                                                    <input class="form-control has-feedback-left" id="filePreview"
                                                           name="filePreview" placeholder="尚未选择文件" required disabled/>
                                                    <span class="fa fa-file-excel-o form-control-feedback left" aria-hidden="true"></span>
                                                </div>
                                                <div class="col-md-4 col-sm-4 col-xs-4">
                                                    <a class="file">点此上传一个Excel文件
                                            ...
                                            <div class="table-responsive">
                                                <table id="datatable" class="table table-striped jambo_table" style="white-space: nowrap;">
                                                    ...
                                                    <c:forEach var="invoice" items="${invoice_list}" varStatus="status">
                                                        ...
                                                        <td class=" " style="color: #00CC33">已导入</td>
                                                        </tr>
                                                    </c:forEach>
                                                    <c:forEach var="invoice" items="${error_invoice_list}" varStatus="status">
                                                        <c:choose>
                                                            <c:when test="${status.index + invoice_list.size() % 2 == 0}">
                                                                <tr class="even pointer">
                                                            </c:when>
                                                            <c:otherwise>
                                                                <tr class="odd pointer">
                                                        ...
                                                        <td class=" ">￥${invoice.totalAmount}</td>
                                                        <td class=" ">￥${invoice.totalTax}</td>
                                                        <td class=" " style="color: #BA2121">未导入</td>
                                                        </tr>
                                                    </c:forEach>
                                                    </tbody>
                                                </table>
