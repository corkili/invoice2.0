                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <h3 style="text-align: center">欢迎使用企业增值税发票数据分析系统！</h3>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="well profile_view">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="left col-xs-7">
                                                ...
                                                <p><strong><i class="fa fa-group"></i> 身份：</strong>
                                                    <c:choose>
                                                        <c:when test="${user.isSuperManager}">超级管理员</c:when>
                                                        <c:when test="${user.isManager}">管理员</c:when>
                                                        <c:otherwise>普通用户</c:otherwise>
                                                    </c:choose>
                                                </p>
                                                <p>
                                                    <strong><i class="fa fa-eye"></i> 权限：</strong><br/>
                                                </p>
